 ...
 * "create" sayfasını açar — kullanıcı dropdown'da seçenek bulamayınca
 * mevcut formu kaybetmeden yeni bir kayıt oluşturabilir, sonra bu
 * sekmeye geri dönüp sayfayı yenileyince dropdown'da görünür.
 */
